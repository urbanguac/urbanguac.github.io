...
$(document).ready(function () {
    ...
    add_normal("<a href='newspaper/index.html'>Click here to view my academic skillset.</a>");
    ...
    add_normal("<a href='robots/index.html'>Click here to view a list of my achievements in the field of robotics.</a>");
    add_normal("");
    add("And most of all, I'm a coder.")
    add_normal("<a href='code/index.html'>Click here to see my life as a coder, minus the coffee.</a>")
    add_normal("<a href='https://www.github.com/urbanguac'>And a portfolio of my projects!</a>")
    add_normal("")
    add("Trying to get in contact with me professionally?")
    add_normal("Check out my <a href='https://www.linkedin.com/in/priansh-shah-828890110/'>LinkedIn</a>!")
    add_normal("")
